...
TOOLS=(alacritty firefox thunar flatpak zoxide dash fzf ripgrep fd udiskie dunst bat eza vim neovim tree-sitter-cli xclip man openssh flameshot xdg-utils)
